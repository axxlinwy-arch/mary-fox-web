    ...
    <section className="relative overflow-hidden py-16 md:py-20">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 md:px-8">
        ...
        <motion.div
          ...
          className="mt-12 flex flex-col items-center text-center md:mt-14"
        >
          <p className="inline-flex max-w-md items-center justify-center gap-2 text-sm uppercase tracking-[0.18em] text-white/80 sm:text-[15px] sm:tracking-[0.22em]">
          ...
          <a
            ...
            className="mt-6 inline-flex flex-col justify-center rounded-lg border-2 border-accent-gold/80 bg-black/65 px-7 py-3.5 backdrop-blur-sm transition-all duration-300 hover:border-accent-gold hover:bg-black/80"
            style={{
              boxShadow:
